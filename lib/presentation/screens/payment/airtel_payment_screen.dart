...
class AirtelPaymentScreen extends StatefulWidget {
  final double total;
  const AirtelPaymentScreen({super.key, this.total = 0.0});

  @override
  State<AirtelPaymentScreen> createState() => _AirtelPaymentScreenState();
}
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFFE4002B).withOpacity(0.4),
                          blurRadius: 20,
